                ...
                <div class="mock-body" style="height: 290px;">
                    ...
                    <div class="mock-main" style="padding: 12px; gap: 10px; overflow-y: auto;">
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #e2e8f0; padding-bottom: 6px; margin-bottom: 8px;">
                            <span style="font-size: 10px; font-weight: 800; color: #0f172a;" id="mock-user-welcome">Hola, Estudiante! 👋</span>
                                ...
                                <div style="display: flex; flex-direction: column; gap: 8px;">
                                    ...
                                    <div class="mock-widget" style="padding: 8px;">
                                        ...
                                        <div style="display: flex; align-items: center; gap: 8px;">
                                            ...
                                            <div style="font-size: 8px; font-weight: 700; color: #334155;" id="mock-dash-progress-text">35%</div>
                                        </div>
                                    </div>
                                    <!-- Widget Pomodoro -->
                                    <div class="mock-widget" style="padding: 8px; display: flex; align-items: center; justify-content: space-between;">
                                        <div>
                                            ...
                                            <div style="font-size: 13px; font-weight: 800; color: #0f172a;" id="mock-dash-pomodoro-timer">25:00</div>
                                        </div>
            ...
            <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 14px; color: var(--text-main); min-width: 600px;">
                ...
                <tbody>
                    <tr style="border-bottom: 1px solid var(--gray-card-border);">
                        <td style="padding: 16px 20px; font-weight: 700; color: var(--text-heading);">Inscripción oficial a cursadas y exámenes</td>
                    ...
                    <tr style="border-bottom: 1px solid var(--gray-card-border);">
                        <td style="padding: 16px 20px; font-weight: 700; color: var(--text-heading);">Árbol visual de correlatividades</td>
                    ...
                    <tr style="border-bottom: 1px solid var(--gray-card-border);">
                        <td style="padding: 16px 20px; font-weight: 700; color: var(--text-heading);">Simulador de promedio y egreso</td>
                    ...
                    <tr style="border-bottom: 1px solid var(--gray-card-border);">
                        <td style="padding: 16px 20px; font-weight: 700; color: var(--text-heading);">Cronómetro Pomodoro y tareas Kanban</td>
                    ...
                    <tr style="border-bottom: 1px solid var(--gray-card-border);">
                        <td style="padding: 16px 20px; font-weight: 700; color: var(--text-heading);">Controlador de cuotas y alertas</td>
                        <td style="padding: 16px 20px; color: #ef4444; background: var(--table-td-bg-siu);">No (No avisa aranceles ni vencimientos)</td>
                        <td style="padding: 16px 20px; color: #10b981; font-weight: 600; background: var(--table-td-bg-cursus);">Sí (Simulador de cuotas TUP/TUSI)</td>
                    </tr>
                    <tr>
                        <td style="padding: 16px 20px; font-weight: 700; color: var(--text-heading);">Diseño moderno e inmediato</td>
    ...
    <section class="section" id="testimonios" style="padding-top: 40px; padding-bottom: 40px;">
        ...
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 24px; max-width: 1100px; margin: 0 auto;" class="steps-grid">
            ...
            <div class="testimonial-card reveal">
                ...
                <div style="display: flex; align-items: center; gap: 12px; border-top: 1px solid var(--card-border); padding-top: 16px;">
                    ...
                    <div>
                        ...
                        <p style="font-size: 11.5px; color: var(--text-desc); margin: 0;">Ing. Industrial (4° Año)</p>
                    </div>
                </div>
            </div>
            ...
            <div class="testimonial-card reveal">
                <div>
                    <div style="color: #f59e0b; font-size: 16px; margin-bottom: 12px;">★★★★★</div>
                    <p style="font-size: 14px; color: var(--text-muted); line-height: 1.6; font-style: italic; margin: 0 0 20px 0;">"Las alertas de vencimientos de cuotas y finales son geniales. Si cursás tecnicaturas con cuota como TUP/TUSI, te avisa los aumentos del arancel al instante. Muy práctico."</p>
                </div>
                <div style="display: flex; align-items: center; gap: 12px; border-top: 1px solid var(--card-border); padding-top: 16px;">
                    ...
                    <div>
                        ...
                        <p style="font-size: 11.5px; color: var(--text-desc); margin: 0;">Estudiante de TUSI (1° Año)</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section" id="contacto">
        <div class="contact-layout">
            <div class="contact-info">
                <div>
                    <span class="section-lbl">Contacto</span>
                    <h2 class="contact-title">¿Tenés alguna consulta?</h2>
